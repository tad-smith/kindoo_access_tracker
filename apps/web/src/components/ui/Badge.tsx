...
// access source, audit action category.
//
...
// Roster type-pill colors: auto = blue (primary-tint / primary),
// manual = warm amber (warn-tint / warn-dark), temp = light amber
// (warn-tint-2 / warn-mid).
