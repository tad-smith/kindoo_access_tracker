...
- Default timeout 60s; bump to 540s for long-running callable functions (e.g. `backfillKindooSiteId`).
...
- `docs/firebase-schema.md` — data model + rules + indexes reference.
